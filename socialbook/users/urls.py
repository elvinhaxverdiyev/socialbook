...
urlpatterns = [
    ...
    path(
    'me/avatar/',
     MeAvatarUploadAPIView.as_view(),
     name='my-avatar-upload'
    ),
    path(
    'me/avatar/select/',
     MeAvatarSelectAPIView.as_view(),
     name='my-avatar-select'
    ),

    # Avatar preset siyahısı
    path(
    'avatars/presets/',
     AvatarPresetListAPIView.as_view(),
     name='avatar-presets'
    ),
    ...
    path(
    'users/suggestions/',
     UserSuggestionsAPIView.as_view(),
    name='user-suggestions'
    ),
    path(
    'users/blocked/',
     BlockedUserListAPIView.as_view(),
    ...
    path(
    'posts/saved/',
    SavedPostListAPIView.as_view(),
    name='post-saved-list'
    ),
    path(
    'posts/<int:post_id>/',
    ...
    'posts/<int:post_id>/save/',
     PostSaveAPIView.as_view(),
     name='post-save'
    ),
    path(
    'posts/<int:post_id>/report/',
     ReportPostAPIView.as_view(),
     name='post-report'
    ),
